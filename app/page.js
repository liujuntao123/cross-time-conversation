  ...
  return (
    <main className="flex min-h-screen bg-gray-100 items-center justify-center p-4">
      <div className="relative w-[90vw] h-[90vh] max-w-[420px] max-h-[800px] min-w-[320px] min-h-[568px] aspect-[9/16]">
        ...
        <p className='fixed bottom-10 left-0 w-full text-center text-xs text-gray-400 flex items-center justify-center'>
          <a href="https://github.com/liujuntao/cross-time-conversation" className="hover:text-gray-500 mr-2 flex items-center" target="_blank" rel="noopener noreferrer">
