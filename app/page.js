...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-100 items-center justify-center p-4">
      <div className="relative w-[90vw] h-[90vh] max-w-[420px] max-h-[800px] min-w-[320px] min-h-[568px] aspect-[9/16]">
              ...
              {showAddCharacter && (
                <div className="absolute inset-0 bg-white z-20">
                  <div className="flex items-center h-11 px-2 border-b border-gray-100">
                    ...
                    <h2 className="flex-1 flex justify-center items-center pr-[36px] text-lg font-normal">
                      添加角色
                    </h2>
                  </div>
                  <div className="p-4">
        ...
        <p className='mt-2 w-full text-center text-xs text-gray-400 flex items-center justify-center'>
